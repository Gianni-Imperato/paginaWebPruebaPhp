...
<head>
  ...
  <title>Tienda | Repuestos Super Shaya</title>
  ...
  <main class="main">
    ...
    <div class="page-title" data-aos="fade">
      <div class="heading heading-con-imagen">
        <img src="assets/img/imagenesTiendas/imagenTiendaShaya/imagenFondoShaya.jpg" alt="Flyer Super Shaya" class="imagen-hero">
        <div class="contenido-heading text-center">
          <div class="container">
            <div class="row d-flex justify-content-center">
              <div class="col-lg-8">
                <h1><span class="resaltar2">Repuestos</span> <span class="resaltar">SUPER</span> <span class="resaltar2">Shaya</span></h1>
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Super Shaya</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaShaya/imagenTiendaShaya1.jpeg" alt="Tienda Repuestos Super Shaya 1">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaShaya/imagenTiendaShaya2.jpeg" alt="Tienda Repuestos Super Shaya 2">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaShaya/imagenTiendaShaya3.jpeg" alt="Tienda Repuestos Super Shaya 3">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaShaya/imagenTiendaShaya4.jpeg" alt="Tienda Repuestos Super Shaya 4">
                </div>
      ...
      <div class="container">
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
            <li data-filter="*" class="filter-active">Shaya</li>
          </ul><!-- End Portfolio Filters -->

          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">

            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaShaya/imagenProductoShaya1.jpeg" class="img-fluid" alt="Bomba de Dirección, Chevrolet Aveo">
              <div class="portfolio-info">
                ...
                <a href="assets/img/imagenesTiendas/imagenTiendaShaya/imagenProductoShaya1.jpeg" title="Somos especialistas en repuestos multimarca, todo para tu vehiculo"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaShaya/imagenProductoShaya2.jpeg" class="img-fluid" alt="Radiador, Dongfeng S30">
              <div class="portfolio-info">
                <h4>Radiador, Dongfeng S30</h4>
                <p>Tenemos todo tipo de repuestos para tu vehiculo, somos multimarcas! Ven y aprovecha nuestros <span class="resaltar">SUPER</span> precios, promociones y descuentos. Cotiza ahora!</p>
                <a href="assets/img/imagenesTiendas/imagenTiendaShaya/imagenProductoShaya2.jpeg" title="Somos especialistas en repuestos multimarca, todo para tu vehiculo"
                  data-gallery="portfolio-gallery-shaya" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaShaya/imagenProductoShaya3.jpeg" class="img-fluid" alt="Arranque, Mazda 3 y Mazda 6">
              <div class="portfolio-info">
                <h4>Arranque, Mazda 3 y Mazda 6</h4>
                <p>Tenemos todo tipo de repuestos para tu vehiculo, somos multimarcas! Ven y aprovecha nuestros <span class="resaltar">SUPER</span> precios, promociones y descuentos. Cotiza ahora!</p>
                <a href="assets/img/imagenesTiendas/imagenTiendaShaya/imagenProductoShaya3.jpeg" title="Somos especialistas en repuestos multimarca, todo para tu vehiculo"
                  data-gallery="portfolio-gallery-shaya" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
          ...
          <div class="swiper-wrapper">
              ...
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosUbicacionTiendas/videoUbicacionShaya.mp4"
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaShaya/promocionShaya1.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaShaya/promocionShaya2.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaShaya/promocionShaya3.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaShaya/promocionShaya4.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
                <h3>Variedad de productos</h3>
