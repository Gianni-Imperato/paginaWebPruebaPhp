  ...
  <main class="main">
    ...
    <div class="page-title" data-aos="fade">
      <div class="heading heading-con-imagen">
        <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaShaya/imagenFondoShaya.jpg')}}" alt="Flyer Super Shaya" class="imagen-hero">
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaShaya/imagenTiendaShaya1.jpeg')}}" alt="Tienda Repuestos Super Shaya 1">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaShaya/imagenTiendaShaya2.jpeg')}}" alt="Tienda Repuestos Super Shaya 2">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaShaya/imagenTiendaShaya3.jpeg')}}" alt="Tienda Repuestos Super Shaya 3">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaShaya/imagenTiendaShaya4.jpeg')}}" alt="Tienda Repuestos Super Shaya 4">
                </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaShaya/promocionShaya1.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaShaya/promocionShaya2.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaShaya/promocionShaya3.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaShaya/promocionShaya4.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
                <h3>Variedad de productos</h3>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4" data-aos="fade-up" data-aos-delay="200">
          <iframe style="border:0; width: 100%; height: 270px;"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3923.1557213931956!2d-66.9441178!3d10.4883879!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8c2a5fba979a98f7%3A0x68e16a1f0a086401!2sRepuestos%20Super%20Shaya%20c.a!5e0!3m2!1ses!2snl!4v1755545620482!5m2!1ses!2snl"
