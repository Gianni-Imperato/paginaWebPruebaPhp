  ...
  <main class="main">
    ...
    <div class="page-title" data-aos="fade">
      <div class="heading heading-con-imagen">
        <img src="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenFondoRepuestos1212.jpg" alt="Flyer Super Repuestos1212" class="imagen-hero">
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenTiendaRepuestos12121.jpeg" alt="Tienda Super Repuestos1212 1">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenTiendaRepuestos12122.jpeg" alt="Tienda Super Repuestos1212 2">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenTiendaRepuestos12123.jpeg" alt="Tienda Super Repuestos1212 3">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenTiendaRepuestos12124.jpeg" alt="Tienda Super Repuestos1212 4">
                </div>
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenProductoRepuestos12121.jpeg" class="img-fluid" alt="Modulo Bomba de Gasolina Completa Explorer 4.6">
              <div class="portfolio-info">
                ...
                <a href="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenProductoRepuestos12121.jpeg" title="Somos especialistas en repuestos Jeep, Ford y multimarca, todo para tu vehiculo"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenProductoRepuestos12122.jpeg" class="img-fluid" alt="Tapa Valvula con Codo, Aveo">
              <div class="portfolio-info">
                <h4>Tapa Valvula con Codo, Aveo</h4>
                <p>Tenemos todo tipo de repuestos para tu vehiculo Jeep y Ford, tambien somos multimarcas! Ven y aprovecha nuestros <span class="resaltar">SUPER</span> precios, promociones y descuentos. Cotiza ahora!</p>
                <a href="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenProductoRepuestos12122.jpeg" title="Somos especialistas en repuestos Jeep, Ford y multimarca, todo para tu vehiculo"
                  data-gallery="portfolio-gallery-repuestos1212" class="glightbox preview-link"><i
                    class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                    class="bi bi-link-45deg"></i></a>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenProductoRepuestos12123.jpeg" class="img-fluid" alt="Kit de Tren Delantero, Arauca">
              <div class="portfolio-info">
                <h4>Kit de Tren Delantero, Arauca</h4>
                <p>Tenemos todo tipo de repuestos para tu vehiculo Jeep y Ford, tambien somos multimarcas! Ven y aprovecha nuestros <span class="resaltar">SUPER</span> precios, promociones y descuentos. Cotiza ahora!</p>
                <a href="assets/img/imagenesTiendas/imagenTiendaRepuestos1212/imagenProductoRepuestos12123.jpeg" title="Somos especialistas en repuestos Jeep, Ford y multimarca, todo para tu vehiculo"
                  data-gallery="portfolio-gallery-repuestos1212" class="glightbox preview-link"><i
                    class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                    class="bi bi-link-45deg"></i></a>
          ...
          <div class="swiper-wrapper">
              ...
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosUbicacionTiendas/videoUbicacionRepuestos1212.mp4"
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaRepuestos1212/promocion12121.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaRepuestos1212/promocion12122.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaRepuestos1212/promocion12123.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
