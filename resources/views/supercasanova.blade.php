...
<head>
  ...
  <title>Tienda | Repuestos Super Casanova</title>
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="{{ route('home') }}#stores"><span>Cotizar</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
  ...
  <main class="main">
    ...
    <div class="page-title" data-aos="fade">
      <div class="heading heading-con-imagen">
        <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaCasanova/imagenFondoCasanova.jpg')}}" alt="Flyer Super Casanova" class="imagen-hero">
        <div class="contenido-heading text-center">
          <div class="container">
            <div class="row d-flex justify-content-center">
              <div class="col-lg-8">
                <h1><span class="resaltar2">Repuestos</span> <span class="resaltar">SUPER</span> <span class="resaltar2">Casanova</span></h1>
                <p class="mb-0"><strong>¡No busques más! Tenemos todo lo que necesitas para el mantenimiento y funcionamiento de tu vehículo. Somos especialistas en <span class="resaltar">Mitsubishi, Kia y Hyundai</span> tambien somos multimarcas! En el SUPER multimarcas de Caracas contamos con cualquier tipo de repuesto para tu vehiculo y servicios de taller, ofreciendo la mejor calidad, excelente atención y precios insuperables.</strong></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Super Casanova</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaCasanova/tiendaSuperCasanova1.jpg')}}" alt="Tienda Super Casanova 1">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaCasanova/tiendaSuperCasanova3.jpg')}}" alt="Tienda Super Casanova 2">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaCasanova/tiendaSuperCasanova4.jpeg')}}" alt="Tienda Super Casanova 3">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaCasanova/tiendaSuperCasanova2.jpeg')}}" alt="Tienda Super Casanova 4">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              <h3>¡Visitanos!</h3>
              <ul>
                <li><strong>Dirección</strong>: Av. Casanova, frente al Hotel Las Américas, Chacaíto</li>
                ...
                <li><strong>Tiktok</strong>: <a href="https://www.tiktok.com/@repuestoscasanova1" target="_blank">@repuestoscasanova1</a></li>
                <li><strong>Instagram</strong>: <a href="https://www.instagram.com/repuestoscasanova/?hl=es-la" target="_blank">@repuestoscasanova</a></li>
                <li><strong>Email</strong>: <a href="mailto:casanovaliderg@gmail.com">casanovaliderg@gmail.com</a></li>
            </ul>
            </div>
      ...
      <div class="container">
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
            <li data-filter="*" class="filter-active">Casanova</li>
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaCasanova/imagenProductoCasanova3.jpeg')}}" class="img-fluid" alt="Delivery Gran Caracas">
              <div class="portfolio-info">
                <h4>Delivery Gran Caracas</h4>
                <p>Ofrecemos nuestro <span class="resaltar">SUPER</span> servicio de Delivery a cualquier parte de la Gran Caracas, en pocos minutos tendrás en tus manos la pieza que resolverá tus problemas mecanicos!</p>
                <a href="{{asset('assets/images/imagenesTiendas/imagenTiendaCasanova/imagenProductoCasanova3.jpeg')}}" title="Servicio de Delivery"
                  data-gallery="portfolio-gallery-casanova" class="glightbox preview-link"><i
                    class="bi bi-zoom-in"></i></a>
                <a href="" title="More Details" class="details-link"><i
                    class="bi bi-link-45deg"></i></a>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaCasanova/promocionCasanova2.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaCasanova/promocionCasanova3.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaCasanova/promocionCasanova1.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4" data-aos="fade-up" data-aos-delay="200">
          <iframe style="border:0; width: 100%; height: 270px;"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d245.19575835927748!2d-66.87043334816578!3d10.490248521911504!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8c2a59b19be76bfb%3A0xf0441b1d19c01488!2sRepuestos%20Super%20Casanova!5e0!3m2!1ses!2sve!4v1740769081963!5m2!1ses!2sve"
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            ...
            <div class="footer-contact pt-3">
              <p>Av. Casanova, frente al Hotel Las Americas</p>
              <p>Caracas, Venezuela</p>
              <p class="mt-3"><strong>Telefono:</strong> <span>+58 4242797050</span></p>
              <p><strong>Email:</strong> <span>casanovaliderg@gmail.com</span></p>
            </div>
            <div class="social-links d-flex mt-4">
              ...
              <a href="https://www.tiktok.com/@repuestoscasanova1"><i class="bi bi-tiktok"></i></a>
            </div>
          </div>
