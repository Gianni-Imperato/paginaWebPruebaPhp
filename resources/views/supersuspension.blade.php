  ...
  <main class="main">
    ...
    <div class="page-title" data-aos="fade">
      <div class="heading heading-con-imagen">
        <img src="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenFondoSuspension.jpg"
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenTiendaSuspension3.jpeg" alt="Tienda Super Suspensión 1">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenTiendaSuspension2.jpeg" alt="Tienda Super Suspensión 2">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenTiendaSuspension1.png" alt="Tienda Super Suspensión 3">
                </div>
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenProductoSuspension1.jpeg" class="img-fluid" alt="Bomba de Dirección, Chevrolet Aveo">
              <div class="portfolio-info">
                ...
                <a href="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenProductoSuspension1.jpeg" title="Somos especialistas en Suspensiones y Tren Delanteros, tambien multimarca, todo para tu vehiculo"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenProductoSuspension2.jpeg" class="img-fluid" alt="Mesetas Superiores, Jeep Cherookee 4G">
              <div class="portfolio-info">
                <h4>Par Mesetas Superiores, Jeep Cherookee 4G</h4>
                <p>Tenemos todo tipo de repuestos para tu vehiculo, Suspensiones y Tren Delanteros, tambien somos multimarcas! Ven y aprovecha nuestros <span class="resaltar">SUPER</span> precios, promociones y descuentos. Cotiza ahora!</p>
                <a href="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenProductoSuspension2.jpeg" title="Somos especialistas en Suspensiones y Tren Delanteros, tambien multimarca, todo para tu vehiculo"
                  data-gallery="portfolio-gallery-suspension" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenProductoSuspension3.jpeg" class="img-fluid" alt="Cuerpo de Aceleración, Chery QQ">
              <div class="portfolio-info">
                <h4>Cuerpo de Aceleración, Chery QQ</h4>
                <p>Tenemos todo tipo de repuestos para tu vehiculo, Suspensiones y Tren Delanteros, tambien somos multimarcas! Ven y aprovecha nuestros <span class="resaltar">SUPER</span> precios, promociones y descuentos. Cotiza ahora!</p>
                <a href="assets/img/imagenesTiendas/imagenTiendaSuspension/imagenProductoSuspension3.jpeg" title="Somos especialistas en Suspensiones y Tren Delanteros, tambien multimarca, todo para tu vehiculo"
                  data-gallery="portfolio-gallery-suspension" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
          ...
          <div class="swiper-wrapper">
              ...
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosUbicacionTiendas/videoUbicacionSuspension.mp4"
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaSuspension/promocionSuspension1.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaSuspension/promocionSuspension2.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
