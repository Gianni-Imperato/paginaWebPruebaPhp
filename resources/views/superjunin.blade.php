...
<head>
  ...
  <title>Tienda | Repuestos Super Junín</title>
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Super Junín</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaJunin/imagenTiendaJunin1.jpeg" alt="Tienda Super Junín 1">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaJunin/imagenTiendaJunin2.jpeg" alt="Tienda Super Junín 2">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/imagenesTiendas/imagenTiendaJunin/imagenTiendaJunin3.jpeg" alt="Tienda Super Junín 3">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              <h3>¡Visitanos!</h3>
              <ul>
                <li><strong>Dirección</strong>: Av. sur 11, Caracas 1014, Distrito Capital, Venezuela</li>
                ...
                <li><strong>Tiktok</strong>: <a href="https://www.tiktok.com/@repuestossuperjunin?_t=ZM-8xt21773bVu&_r=1" target="_blank">@repuestossuperjunin</a></li>
                <li><strong>Instagram</strong>: <a href="https://www.instagram.com/repuestosjunin1212/?hl=es" target="_blank">@repuestosjunin1212</a></li>
                <li><strong>Email</strong>: <a href="mailto:repuestosjunin1212@gmail.com">repuestosjunin1212@gmail.com</a></li>
            </ul>
            </div>
      ...
      <div class="container">
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
            <li data-filter="*" class="filter-active">Junín</li>
          </ul><!-- End Portfolio Filters -->

          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">

            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaJunin/imagenProductoJunin1.jpeg" class="img-fluid" alt="Chery Arauca y X1">
              <div class="portfolio-info">
                ...
                <a href="assets/img/imagenesTiendas/imagenTiendaJunin/imagenProductoJunin1.jpeg" title="Somos especialistas en Chery, Jac, Dongfeng, Saic, Zotye y Haima"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaJunin/imagenProductoJunin2.jpeg" class="img-fluid" alt="Haima 7">
              <div class="portfolio-info">
                <h4>Haima 7</h4>
                <p>Tenemos todo tipo de repuestos para tu vehiculo Chery, Jac, Dongfeng, Saic, Zotye y Haima, tambien somos multimarcas! Ven y aprovecha nuestros <span class="resaltar">SUPER</span> precios, promociones y descuentos. Cotiza ahora!</p>
                <a href="assets/img/imagenesTiendas/imagenTiendaJunin/imagenProductoJunin2.jpeg" title="Somos especialistas en Chery, Jac, Dongfeng, Saic, Zotye y Haima"
                  data-gallery="portfolio-gallery-junin" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-casanova">
              <img src="assets/img/imagenesTiendas/imagenTiendaJunin/imagenProductoJunin3.jpeg" class="img-fluid" alt="Dongfeng Motors ZNA">
              <div class="portfolio-info">
                <h4>Dongfeng Motors ZNA</h4>
                <p>Tenemos todo tipo de repuestos para tu vehiculo Chery, Jac, Dongfeng, Saic, Zotye y Haima, tambien somos multimarcas! Ven y aprovecha nuestros <span class="resaltar">SUPER</span> precios, promociones y descuentos. Cotiza ahora!</p>
                <a href="assets/img/imagenesTiendas/imagenTiendaJunin/imagenProductoJunin3.jpeg" title="Somos especialistas en Chery, Jac, Dongfeng, Saic, Zotye y Haima"
                  data-gallery="portfolio-gallery-junin" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
          ...
          <div class="swiper-wrapper">
              ...
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosUbicacionTiendas/videoUbicacionJunin.mp4"
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaJunin/promocionJunin1.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaJunin/promocionJunin2.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="assets/img/videosTiendas/videosTiendaJunin/promocionJunin3.mp4"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4" data-aos="fade-up" data-aos-delay="200">
          <iframe style="border:0; width: 100%; height: 270px;"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3923.057620177023!2d-66.9082634!3d10.4961241!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8c2a5f3dfc5d9d7f%3A0xc62d744c6f42c2a6!2sRepuestos%20S%C3%BAper%20Jun%C3%ADn%201212!5e0!3m2!1ses!2sfr!4v1753115306705!5m2!1ses!2sfr"
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            ...
            <div class="footer-contact pt-3">
              ...
              <p><strong>Email:</strong> <span>repuestosjunin1212@gmail.com</span></p>
            </div>
            <div class="social-links d-flex mt-4">
              <a href="https://x.com/repuestojunin"><i class="bi bi-twitter-x"></i></a>
              <a href="https://www.facebook.com/repuestojunin"><i class="bi bi-facebook"></i></a>
              <a href="https://www.instagram.com/repuestosjunin1212/?hl=es"><i class="bi bi-instagram"></i></a>
              <a href="https://www.tiktok.com/@repuestossuperjunin?_t=ZM-8xt21773bVu&_r=1"><i class="bi bi-tiktok"></i></a>
            </div>
          </div>
