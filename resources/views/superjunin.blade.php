  ...
  <main class="main">
    ...
    <div class="page-title" data-aos="fade">
      <div class="heading heading-con-imagen">
        <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaJunin/imagenFondoJunin.jpg')}}" alt="Flyer Super Junín" class="imagen-hero">
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaJunin/imagenTiendaJunin1.jpeg')}}" alt="Tienda Super Junín 1">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaJunin/imagenTiendaJunin2.jpeg')}}" alt="Tienda Super Junín 2">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/images/imagenesTiendas/imagenTiendaJunin/imagenTiendaJunin3.jpeg')}}" alt="Tienda Super Junín 3">
                </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaJunin/promocionJunin1.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaJunin/promocionJunin2.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
            ...
            <div class="swiper-slide">
              <div class="video-item">
                <div class="video-wrapper">
                  <video controls preload="metadata">
                    <source src="{{asset('assets/images/videosTiendas/videosTiendaJunin/promocionJunin3.mp4')}}"
                      type="video/mp4"> Tu navegador no soporta el elemento de video.
                  </video>
                </div>
