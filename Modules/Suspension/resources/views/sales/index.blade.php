    ...
    <div class="card">
        ...
        <div class='card-body'>
            <div class="row" style="margin-left: 2em" style="margin-top: -5em">
              <span><h3 style="color: #39c">Reporte de Ventas</h3></span>
            </div>

            <form action="{{route('suspvencom.show')}}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="r col-md-3">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="tra" name="sales" value="{{$sale}}">
                        </div>
                    </div>
                </div>
                <br>
            ...
            <table  id="myTable" class="table table-hover" style="background-color:  #e6e6e6">
                ...
                <tr>
                    ...
                    <th class="col-md-2 header-grid">Referencia</th>
