...
@section('contenido')
    ...
    <div class="card">
        ...
        <div class='card-body'>
            ...
            <form action="{{route('shaipagos.show')}}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="r col-md-3">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="tra" name="income" value="{{$income}}">
                        </div>
                    </div>
                </div>
                <br>
            ...
            <table  id="myTable" class="table table-hover" style="background-color:  #e6e6e6">
                ...
                <tr>
                    ...
                    <th class="col-md-2 header-grid">Cedula|Rif</th>
                    <th class="col-md-2 header-grid">Cliente</th>
                    <th class="col-md-2 header-grid">Cajero</th>
                    <th class="col-md-2 header-grid">Monto Venta</th>
                    <th class="col-md-2 header-grid"></th>
                </tr>
                </thead>
                <tbody>
                <tr>
    ...
    <script src="assets/js/script_income.js" ></script>
