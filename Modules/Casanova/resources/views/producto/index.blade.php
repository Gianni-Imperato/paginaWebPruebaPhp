                ...
                <tbody>
                  @foreach ($datos as $producto)
                    <tr>
                        <td>{{ $producto->id }}</td>
                        <td>
                          <img class="img-thumbnail img-fluid" src="{{ asset('storage').'/'.$producto->clase }}" width="150" alt="">
                        </td>
                        ...
                        <td>
                          <a href="{{url('/casaproducto/'.$producto->id.'/edit')}}" class="btn waves-effect waves-light btn-xs btn-info">Edit</a> 
                        </td>
                      </tr>
                    @endforeach
                </tbody>
